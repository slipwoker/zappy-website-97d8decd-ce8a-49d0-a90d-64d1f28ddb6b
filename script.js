document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      ...
      const existingError = field.parentNode.querySelector('.error-message[data-for="' + field.name + '"]');
      if (existingError) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "EIGHTEEN 70 משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '97d8decd-ce8a-49d0-a90d-64d1f28ddb6b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '97d8decd-ce8a-49d0-a90d-64d1f28ddb6b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '97d8decd-ce8a-49d0-a90d-64d1f28ddb6b';
